...
featured_links:
  - href: "/lugares/almada/"
    name_pt: "Almada"
    name_en: "Almada"
    description_pt: "O concelho onde Cacilhas se insere — do Cristo Rei à Costa da Caparica."
    description_en: "The concelho Cacilhas sits in — from Cristo Rei to the Costa da Caparica."
  - href: "/lugares/almada/almada-cova-da-piedade-pragal-e-cacilhas/"
    name_pt: "União das Freguesias"
    name_en: "Union of Parishes"
    description_pt: "A união administrativa que inclui Cacilhas desde a reforma de 2013."
...
en:
  ...
  body: |
    ...
    **Ginjal Terrasse**, on the river itself, is a terrace bar with sunset views and light snacks.
    ...
    - **Shopping** — small shops and a mercado near the ferry, with full supermarkets in the surrounding parishes. Almada Forum (a large mall) is a 10-minute bus ride south.
    - **Parking** is limited near the riverfront; residents typically park higher up the hill or in the surrounding parishes.
