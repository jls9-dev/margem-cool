...
level: concelho
name_pt: "Sesimbra"
hero_image: "sesimbra-do-castelo"
hero_image_alt_pt: "Vista sobre a vila de Sesimbra e a baía, a partir do castelo."
hero_image_alt_en: "Vista sobre a vila de Sesimbra e a baía, a partir do castelo."
hero_image_caption_pt: "Sesimbra vista do castelo. O casario branco desce até à praia abrigada, com o mar aberto para lá dela."
hero_image_caption_en: "Sesimbra vista do castelo. O casario branco desce até à praia abrigada, com o mar aberto para lá dela."
hero_image_credit: "Margem Cool"

pt:
  short_description: "Vila piscatória com lota própria, praia abrigada e castelo no alto. O concelho vai da Lagoa de Albufeira ao Cabo Espichel."
  page_status: developed
  meta_title: "Sesimbra — vila, praias, castelo e Cabo Espichel"
  meta_description: "Guia de Sesimbra: a vila piscatória, o castelo, as praias, a Lagoa de Albufeira, o Cabo Espichel e como chegar."
  facts:
    - value: "52 384"
    ...
    - value: "Lota"
      label: "Frota e leilão de peixe próprios"
    - value: "Espichel"
      label: "O fim da península"
  faqs:
    - question: "O que há para fazer em Sesimbra?"
      answer: "A vila e a praia abrigada, o castelo no alto com vista sobre a baía, o Cabo Espichel no extremo poente, a Lagoa de Albufeira a norte, e as praias da Arrábida do outro lado da serra. Comer peixe é metade do programa."
    - question: "Como se chega a Sesimbra?"
      answer: "De carro, cerca de 45 minutos a uma hora de Lisboa pela Ponte 25 de Abril e A2. Não há comboio. Há carreiras da Carris Metropolitana, com menos frequência fora do verão."
    - question: "A praia de Sesimbra é boa?"
      answer: "É das poucas praias abrigadas da costa atlântica portuguesa — a serra corta a ondulação, a água fica mais calma e mais quente do que na Caparica. Em Agosto enche de manhã."
    - question: "O que se come em Sesimbra?"
  ...
  transport_options:
    - mode: "Carro"
      duration: "45–60 min"
      detail: "Ponte 25 de Abril e A2, saída para Sesimbra. Estacionar na vila em Agosto é difícil — há parques acima do casario."
    - mode: "Autocarro"
      duration: "Frequência variável"
      detail: "Carris Metropolitana a partir de Lisboa e do resto da Margem Sul. Muito menos frequente fora da época balnear."
  body: |
    Sesimbra vive do mar de uma forma que quase nenhuma vila da região ainda vive. Tem lota própria, frota própria e uma baía abrigada por trás da serra, e isso organiza tudo o resto — o que se come, a que horas abrem as coisas, e porque é que a vila está onde está.

    O concelho é maior do que a vila sugere. Estende-se da **Lagoa de Albufeira** a norte até ao **Cabo Espichel** a poente, com a serra da Arrábida a fechar por nascente. São quase duzentos quilómetros quadrados para cinquenta e poucos mil habitantes, e grande parte deles é mato, pinhal e arriba.

    ## A vila

    Casario branco encostado à encosta, praia abrigada mesmo em frente, e o **Castelo de Sesimbra** no alto, mourisco na origem e reconstruído depois da Reconquista. A subida ao castelo dá a vista que toda a gente fotografa: a vila lá em baixo, a baía, e o mar aberto para lá dela.

    A praia da vila é das poucas praias abrigadas da costa atlântica portuguesa — a serra corta a ondulação e a água fica mais calma do que na Caparica, a meia hora dali.

    ## O Cabo Espichel

    No extremo poente do concelho, a península acaba numa arriba de mais de cem metros, com um santuário de romaria do século XVIII, um farol de 1790 e pegadas de dinossauro na rocha. É o sítio mais estranho e mais bonito da Margem Sul e tem [guia próprio](/guias/cabo-espichel/).

    ## A Lagoa de Albufeira

    A norte, uma laguna costeira separada do Atlântico por um cordão de areia: água rasa e morna de um lado, ondas do outro, a duzentos metros de distância. É o melhor sítio da região com crianças pequenas e um dos principais spots de kitesurf. Também tem [guia](/guias/lagoa-de-albufeira/).
    ...
    **Como escolher:** pergunta o que entrou hoje. Numa vila com lota, a casa que responde bem a essa pergunta é a casa certa; a que não responde está a servir congelado como toda a gente.
    ...
    Sesimbra em Agosto é outra vila. A população multiplica-se, estacionar torna-se um desporto e a praia da vila enche de manhã. Fora da época é um sítio pequeno e sossegado, com muita coisa fechada.
...
Placeholder page for the concelho of Sesimbra. Editorial content to come in Phase 1.
