...
level: concelho
name_pt: "Setúbal"
hero_image: "setubal-marina"
hero_image_alt_pt: "A marina de Setúbal com barcos atracados e a cidade por trás."
hero_image_alt_en: "A marina de Setúbal com barcos atracados e a cidade por trás."
hero_image_caption_pt: "A frente ribeirinha de Setúbal. A cidade vive virada ao Sado, e a lota é a meio caminho entre isto e o mercado."
hero_image_caption_en: "A frente ribeirinha de Setúbal. A cidade vive virada ao Sado, e a lota é a meio caminho entre isto e o mercado."
hero_image_credit: "Margem Cool"

pt:
  short_description: "Cidade a sério na foz do Sado, entre o estuário e a serra da Arrábida. Capital de distrito, com lota, mercado, praias de serra e o choco frito."
  page_status: developed
  meta_title: "Setúbal — a cidade, a Arrábida e o Sado"
  meta_description: "Guia de Setúbal: o que é a cidade, as praias da Arrábida, o Mercado do Livramento, o choco frito, os golfinhos do Sado e como chegar."
  facts:
    - value: "123 496"
      label: "Habitantes (2021)"
    - value: "230 km²"
      label: "Área do concelho"
    - value: "Arrábida"
      label: "Parque natural a poente"
    - value: "Choco frito"
      label: "O prato da cidade"
  faqs:
    - question: "Vale a pena visitar Setúbal?"
      answer: "Sim, e por razões diferentes das de Lisboa. É uma cidade portuguesa a funcionar, com mercado, lota e centro histórico, e tem à porta as praias da Arrábida e o estuário do Sado com golfinhos residentes. Não é um destino de postal — é um sítio onde se vive."
    - question: "Como se vai de Lisboa para Setúbal?"
      answer: "De comboio pela linha do Sul, a partir do Roma-Areeiro ou de Lisboa, ou de carro pela Ponte 25 de Abril e A2. Conta cerca de 50 minutos por qualquer das vias. A Fertagus não serve Setúbal."
    - question: "O que se come em Setúbal?"
      answer: "Choco frito, antes de tudo. Depois peixe e marisco do Sado, comprados no Mercado do Livramento pela manhã e cozinhados nos restaurantes à volta. E moscatel de Setúbal, que se guarda para o fim da refeição."
    - question: "Quais são as praias de Setúbal?"
      answer: "As da Arrábida — Figueirinha, Galapos, Galapinhos, Portinho, Creiro — e Albarquel, praticamente na cidade. Entre 4 de Junho e 15 de Setembro o acesso de carro é condicionado das 07h às 20h."
    - question: "Há golfinhos no Sado?"
  ...
  transport_options:
    - mode: "Comboio"
      duration: "~50 min"
      detail: "Linha do Sul a partir de Lisboa. A Fertagus não chega a Setúbal — troca-se em Pragal ou vem-se directamente pela linha do Sul."
    - mode: "Carro"
      duration: "~50 min"
      detail: "Ponte 25 de Abril e A2. Estacionamento pago no centro e na frente ribeirinha."
    - mode: "Ferry para Tróia"
      duration: "~20 min"
      detail: "Da frente ribeirinha da cidade para a restinga de Tróia, com travessia para passageiros e para carros."
  body: |
    Setúbal não é um subúrbio de Lisboa. É uma cidade com vida própria, capital de distrito, com porto, lota, universidade e um centro histórico que não depende de ninguém. Fica a cinquenta minutos da capital e comporta-se como se ficasse a duzentos.

    A geografia explica quase tudo. A cidade está entalada entre duas coisas grandes: o **estuário do Sado** a sul, com a restinga de Tróia do outro lado da água, e a **serra da Arrábida** a poente, que cai a pique para o mar. Entre as duas, uma frente ribeirinha de trabalho — barcos de pesca, ferries para Tróia, o cheiro da lota de manhã.

    ## O que a cidade come

    Setúbal é a capital do **choco frito** e leva o assunto a sério. Faz-se em dezenas de casas e a discussão sobre quem o faz melhor é um passatempo local com décadas. Tem [guia próprio](/guias/choco-frito/).

    O abastecimento vem do **Mercado do Livramento**, o mercado municipal de 1930 com painéis de azulejo dos anos 30 e 40, onde os restaurantes da cidade compram o peixe de manhã. Encerra à segunda; funciona de manhã. Também tem [guia](/guias/mercado-do-livramento/).

    ## A Arrábida

    Metade do concelho é serra. O Parque Natural da Arrábida ocupa a faixa poente e leva consigo as praias mais bonitas da região — Figueirinha, Galapos, Galapinhos, Portinho — enseadas de água parada e transparente viradas a sul, protegidas da ondulação atlântica.

    De 4 de Junho a 15 de Setembro o acesso de carro é condicionado todos os dias das 07h às 20h. É a informação mais útil que existe sobre a Arrábida em Agosto, e está no [guia das praias](/guias/praias-da-arrabida/).

    ## O Sado

    O estuário é reserva natural e tem uma população residente de **roazes** — golfinhos que vivem ali o ano inteiro, não de passagem. Saem barcos da marina para os ver.

    Do outro lado, a restinga de **Tróia**, alcançável de ferry a partir da cidade. É outro concelho e outro distrito, mas para efeitos práticos é a praia em frente.
    ...
    **Manuel Maria Barbosa du Bocage** nasceu em Setúbal em 1765 e é o filho mais conhecido da cidade — poeta satírico, boémio, preso pela Inquisição, e depois figura fundadora do romantismo português. A praça central chama-se **Praça de Bocage**, com a sua estátua no meio, e é o ponto onde a cidade se encontra.
    ...
    A frente ribeirinha da cidade é um porto a trabalhar, não uma marina de postal — há gruas, contentores e um terminal de contentores em plena actividade a leste. Quem vem à espera de Cascais fica desapontado; quem vem à espera de uma cidade portuguesa a funcionar, não.
...
Placeholder page for the concelho of Setúbal. Editorial content to come in Phase 1.
